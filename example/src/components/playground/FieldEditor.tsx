...
export default function FieldEditor({
    ...
    const [newFieldType, setNewFieldType] = useState<PlaygroundField['type']>('text');
        ...
        <div className="flex flex-col h-full bg-background">
            <div className="p-4 border-b">
                ...
                <div className="flex gap-2">
                    <Select
                        value={newFieldType}
                        onValueChange={(val) => setNewFieldType(val as PlaygroundField['type'])}
                    >
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Input
                                        ...
                                        disabled={['checkbox', 'switch', 'slider'].includes(selectedField.type)}
                                    />
                                </div>
                                    ...
                                    <div className="space-y-2 pt-2 border-t">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                const options = values.map(v => ({ label: v, value: v.toLowerCase().replace(/\s+/g, '_') }));
                                                onUpdateField(selectedField.id, { options });
                                            }}
                                        />
                                        <p className="text-[10px] text-muted-foreground">Simple comma separation for now.</p>
                                    </div>
                                )}
                            </div>
                        </div>
